        ...
        <el-col :span="12">
          <div class="grid-content bg-purple" prop="financialNo">
            <el-form-item label="理财产品编号(银行)">
              <el-input v-model="ruleForm.financialNo" :disabled="shuhuiSwatch" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="理财产品名称" prop="productName">
              <el-input v-model="ruleForm.productName" :disabled="shuhuiSwatch" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="开户银行" prop="bankName">
              <el-input v-model="ruleForm.bankName" :disabled="shuhuiSwatch" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="期限(天)" prop="daysNum">
              <el-input v-model="ruleForm.daysNum" :disabled="shuhuiSwatch" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="预计收益率(%)" prop="expectEarn">
              <el-input v-model="ruleForm.expectEarn" :disabled="shuhuiSwatch" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="购买金额(元)">
              <el-input v-model="ruleForm.buyLimit" :disabled="shuhuiSwatch" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="购买编号" prop="buyNo">
              <el-input v-model="ruleForm.buyNo" :disabled="true" size="small"></el-input>
            </el-form-item>
          </div>
        </el-col>
      </el-row>
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="期限(天)">
          <template slot-scope="scope">
            <el-input type="number" v-model="scope.row.daysNum" size="small" />
          </template>
        </el-table-column>

        <el-table-column label="收益率(%)">
          <template slot-scope="scope">
            <el-input v-model="scope.row.expectEarn" size="small" />
          </template>
        </el-table-column>

        <el-table-column label="赎回本金(元)">
          <template slot-scope="scope">
            <el-input v-model="scope.row.redemSum" size="small" />
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    addshuhui() {
      ...
      params.redemSum = this.redemSum;
      params.finanBackDTOS = this.tableData;
      this.$store.dispatch("licaichanpin/applyFinanBToUpdate", params);
    },
    submitForm(formName, val) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          if (val === "update") {
            this.$store.dispatch("licaichanpin/applyFinancialUpdate", params);
          }
        } else {
          swatch = false;
        }
