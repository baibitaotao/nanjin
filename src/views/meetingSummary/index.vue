  ...
  <div class="page">
    <div>
      <div>
        ...
        <el-input v-model="queryParams.keyWord" placeholder="请输入纪要编号/会议类型搜索" class="input-with-select" size="small">
        </el-input>
  ...
  methods: {
    ...
    option(val) {
      if (val == "111") {
        ...
        this.$store
          .dispatch("meetingSummary/meetingSummaryToEdit", params)
          .then(res => {
        ...
        this.$confirm("是否确认删除?", "提示", {
          ...
          .then(() => {
            ...
            this.$store
              .dispatch("meetingSummary/meetingSummaryDelete", params.join(","))
              .then(res => {
                if (res.status == "0") {
