<template>
  <div class="addOrModifyLC">
    ...
    <el-form ref="ruleForm" :model="ruleForm" :rules="rules">
      <el-row style="borderTop:1px solid #dbdbdb">
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="固定资产分类" prop="patentId">
              <el-select v-model="ruleForm.patentId" placeholder="请选择" @change="clear">
                <el-option
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple bianhao">
            <el-form-item label="物品种类" prop="itemId">
              <el-select v-model="ruleForm.itemId" placeholder="请选择" @change="clearItem">
                <el-option
    ...
    submitForm(formName, val) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          if (val === "update") {
            this.$store
              .dispatch("LC/assetsStockUpdateScrapProcess", params)
              .then(res => {});
          }
        } else {
          swatch = false;
