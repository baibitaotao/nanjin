...
export default {
  ...
  data() {
    return {
      ...
      allItem: 0,
      buttons: [
        { code: "111", name: "采购申请", btnScope: "normal" },
  ...
  methods: {
    ...
    option(val) {
      if (val == "111") {
        ...
        this.$store
          .dispatch("caigoushenqing/purchaseToEdit", params)
          .then(res => {
        ...
        this.$confirm("是否确认删除?", "提示", {
          ...
          .then(() => {
            ...
            this.$store
              .dispatch("caigoushenqing/purchaseDelete", params.join(","))
              .then(res => {
                if (res.status == "0") {
