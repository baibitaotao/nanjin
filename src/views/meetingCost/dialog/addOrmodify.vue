<template>
  <div class="addOrModify">
    <el-dialog title="会议申请新增" :visible.sync="dialogFormVisible">
      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="会议费用(元)" prop="meetingAmount">
        ...
        if (valid) {
          ...
          if (val === "save") {
            this.$store
              .dispatch(
                this.isAddOrMOdify
                  ? "meetingCost/meetingCostAdd"
                  : "meetingCost/meetingCostUpdate",
                params
              )
              .then(res => {
                if (res.status === "0") {
            ...
            this.$store
              .dispatch("meetingCost/meetingCostSubmit", params)
              .then(res => {
