        ...
        <el-col :span="12">
          <div class="grid-content bg-purple">
            <el-form-item label="采购种类"  prop="itemId">
              <el-select v-model="ruleForm.itemId" placeholder="请选择" size="small">
                <el-option
  ...
  methods: {
    showDialog(val, item) {
      ...
      if (val === "111") {
        ...
        this.ruleForm.unitPrice = item[0].unitPrice;
    ...
    submitForm(formName, val) {
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
           swatch = true;
          if (val === "update") {
            this.$store.dispatch("caigoushenqing/purchaseUpdate", params);
          }
        } else {
          swatch = false;
        }
