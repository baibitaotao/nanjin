<template>
  <div class="table">
    <el-table :data="tableData" style="width: 100%" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column prop="vacationStartTime" label="请假开始时间"></el-table-column>
      <el-table-column prop="vacationEndTime" label="请假结束时间"></el-table-column>
      <el-table-column prop="vacationTypeName" label="请假类型"></el-table-column>
      <el-table-column prop="vacationStatusName" label="请假状态"></el-table-column>
...
export default {
  ...
  methods: {
    getTableList() {
      this.$store
        .dispatch("applyVacation/applyVacationListZH", this.queryParams)
        .then(res => {
